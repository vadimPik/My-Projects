...
const BeerModal = (props) => {
  ...
  //  const modalBody = getModalBody(description, brewers_tips, contributed_by, first_brewed);
    const modalBody = getModalBody();
    
    return (
        // <ModalWindow  isShow={ props.isShow } title={ 'test' }  body= { modalBody } onCancel={ cancelModalHandler } 
        //               onHide= { hideHandler}  isShowConfimButton= {false} size="xl" key={id}/>  
        <ModalWindow  isShow={ props.isShow } title={ 'test' }  body= { modalBody } onCancel={ cancelModalHandler } 
